...
def run_db(db_name, holdout_df,treatment_column_name,outcome_column_name, cur, conn, reg_param = 0.1):
    ...
    while len(cur_covs)>1:        
        ...
        # drop the cov Based on the ordered list "sorted_x"
...
#     res = run_db(input_data, holdout_data, len(holdout_data.columns)-2,
